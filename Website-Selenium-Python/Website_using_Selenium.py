...
#driver = webdriver.Chrome(ChromeDriverManager().install()) #automatically install the current webdriver version, thus we won't need to install again and again.
...
driver.find_element(By.ID,'email_create').send_keys("nafis.3@hotmail.com") ## filling up the email address field of create account section by using its unique id from the inspect
...
#in line 40-63--> clicking and filling up the fields by using their unique id
...
driver.find_element(By.ID, 'company').send_keys("Automation_Company")
...
#in line 75-104--> clicking and filling up the fields by using their unique id
...
driver.find_element(By.ID, 'company').send_keys("Manual_company")
driver.find_element(By.ID, 'address1').send_keys("Block-f, Section-2, Dhaka-1216")
driver.find_element(By.ID, 'address2').send_keys("House-9, Aveneue-1")
driver.find_element(By.ID, 'city').send_keys("Mirpur")
driver.find_element(By.ID, 'id_state').send_keys("Texas")
...
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------Going to Casual Dresses section and adding a dress into the cart--------------------------------
...
#--------------------------------------Proceeding to Checkout > Paying by check > Confirming the order > Signing out----------------
